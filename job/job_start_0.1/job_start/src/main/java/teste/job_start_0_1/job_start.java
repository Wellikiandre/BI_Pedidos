...
/**
 * Job: job_start Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class job_start implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_start";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_start.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_TESTE_job_start = new byte[0];
    static byte[] commonByteArray_TESTE_job_start = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TESTE_job_start) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		teste.click_0_1.CLICK childJob_tRunJob_1 = new teste.click_0_1.CLICK();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		teste.aging_historico_0_1.AGING_HISTORICO childJob_tRunJob_2 = new teste.aging_historico_0_1.AGING_HISTORICO();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		teste.sidara_0_1.SIDARA childJob_tRunJob_3 = new teste.sidara_0_1.SIDARA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		teste.siebel_click_0_1.SIEBEL_CLICK childJob_tRunJob_4 = new teste.siebel_click_0_1.SIEBEL_CLICK();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final job_start job_startClass = new job_start();

        int exitCode = job_startClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_start.class.getClassLoader().getResourceAsStream("teste/job_start_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_start.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_start");
        }
...
/************************************************************************************************
 *     49492 characters generated by Talend Open Studio for Data Integration 
 *     on the 11 de Janeiro de 2022 14h26min2s BRT
 ************************************************************************************************/